...
def fetch_score(
    ...
    G_C = graph_connection(kneighbors_graph(sub_adata.obsm['X_qz'], 15), sub_adata.obs['label'].values)
    clisi = scib.metrics.clisi_graph(sub_adata, 'label', 'embed', 'X_qz', n_cores=26)
